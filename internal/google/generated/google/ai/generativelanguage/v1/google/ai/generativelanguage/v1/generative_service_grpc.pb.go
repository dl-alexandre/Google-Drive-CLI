...
// All implementations must embed UnimplementedGenerativeServiceServer
...
// UnimplementedGenerativeServiceServer must be embedded to have
...
func (UnimplementedGenerativeServiceServer) BatchEmbedContents(context.Context, *BatchEmbedContentsRequest) (*BatchEmbedContentsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method BatchEmbedContents not implemented")
}
...
func (UnimplementedGenerativeServiceServer) mustEmbedUnimplementedGenerativeServiceServer() {}
...
func RegisterGenerativeServiceServer(s grpc.ServiceRegistrar, srv GenerativeServiceServer) {
	// If the following call panics, it indicates UnimplementedGenerativeServiceServer was
